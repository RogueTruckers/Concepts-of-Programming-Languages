...
{
    let myList = new Cons(this.head, this.tail.append(list));
    return myList;
};
...
Cons.prototype.filter = function (operation)
{
    if (operation(this.head))
        return new Cons(this.head, this.tail.filter(operation));
    else
        return this.tail.filter(operation);
};

Cons.prototype.map = function (operation)
{
    return new Cons(operation(this.head), this.tail.map(operation));
};
...
Nil.prototype.contains = function (list)
{
    return false;
};

Nil.prototype.filter = function (operation)
{
    return new Nil();
};

Nil.prototype.map = function (operation)
{
    return new Nil();
}
